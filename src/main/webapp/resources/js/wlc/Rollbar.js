var _rollbarConfig = {
  accessToken: "584c4020ebc341c09d41e01eb80c2f97",
...
!function (a, b) {
  function c(b) {
    this.shimId = ++h, this.notifier = null, this.parentShim = b, this.logger = function () {
  ...
  function e(b) {
    ...
    return g(function () {
      if (this.notifier)
        return this.notifier[b].apply(this.notifier, arguments);
  ...
  function g(a, b) {
    return b = b || this.logger, function () {
      try {
  ...
  c.init = function (a, b) {
    ...
    return g(function () {
      if (h.configure(b), b.captureUncaught) {
        ...
        for (g = 0; g < j.length; ++g)
          i = j[g], a[i] && a[i].prototype && f(h, a[i].prototype)
      }
      return a[e] = h, h
    }, h.logger)()
    ...
    try {
      ...
      if (!b._wrapped) {
        ...
        for (var e in b)
          b.hasOwnProperty(e) && (b._wrapped[e] = b[e])
      }
      return b._wrapped
    } catch (f) {
      return b
  ...
  for (var i = "log,debug,info,warn,warning,error,critical,global,configure,scope,uncaughtError".split(","), j = 0; j < i.length; ++j)
    c.prototype[i[j]] = e(i[j]);
