              ...
              buildCategory(
                      ...
                      Arrays.asList(new Playlist[]{
                        ...
                        buildPlaylist(
                                ...
                                "F544CEEC9432BF67",
                                sdf.parse("2013-08-31 12:17:10"),
                                // TODO DESC TO LONG"In diesen Videos wird gezeigt, wie man die Verbindung zu einer MySQL-Datenbank herstellt und Persistent Entites generiert. Außerdem wird gezeigt, wie auf diese Persistent Entities über eine Session Bean innerhalb eines Web-Servlets zugegriffen werden kann.",
                                "SHORT DESC",
                                Difficulty.EASY,
                                true,
                                sdf.parse("2013-08-31 12:17:10"),
