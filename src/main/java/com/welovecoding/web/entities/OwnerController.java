...
import com.welovecoding.web.jpa.session.OwnerFacade;
...
public class OwnerController implements Serializable {
  ...
  @EJB
  private com.welovecoding.web.jpa.session.OwnerFacade ejbFacade;
  ...
  public String create() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("OwnerCreated"));
  ...
  public String update() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("OwnerUpdated"));
      return "View";
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/AdminPages").getString("PersistenceErrorOccured"));
      return null;
  ...
  private void performDestroy() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("OwnerDeleted"));
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/AdminPages").getString("PersistenceErrorOccured"));
    }
  }
