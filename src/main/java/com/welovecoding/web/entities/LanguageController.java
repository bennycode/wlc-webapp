...
import com.welovecoding.web.jpa.session.LanguageFacade;
...
public class LanguageController implements Serializable {
  ...
  @EJB
  private com.welovecoding.web.jpa.session.LanguageFacade ejbFacade;
  ...
  public String create() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("LanguageCreated"));
  ...
  public String update() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("LanguageUpdated"));
      return "View";
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/AdminPages").getString("PersistenceErrorOccured"));
      return null;
  ...
  private void performDestroy() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("LanguageDeleted"));
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/AdminPages").getString("PersistenceErrorOccured"));
    }
  }
  ...
  public Language getLanguage(java.lang.Integer id) {
