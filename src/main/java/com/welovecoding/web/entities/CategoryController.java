...
import com.welovecoding.web.jpa.session.CategoryFacade;
...
public class CategoryController implements Serializable {
  ...
  @EJB
  private com.welovecoding.web.jpa.session.CategoryFacade ejbFacade;
  ...
  public String create() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("CategoryCreated"));
  ...
  public String update() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("CategoryUpdated"));
      return "View";
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/AdminPages").getString("PersistenceErrorOccured"));
      return null;
  ...
  private void performDestroy() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("CategoryDeleted"));
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/AdminPages").getString("PersistenceErrorOccured"));
    }
  }
