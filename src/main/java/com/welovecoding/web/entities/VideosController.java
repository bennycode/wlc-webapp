...
import com.welovecoding.web.jpa.session.VideosFacade;
...
public class VideosController implements Serializable {
  ...
  private Videos current;
  private DataModel items = null;
  @EJB
  private com.welovecoding.web.jpa.session.VideosFacade ejbFacade;
  ...
  public String prepareView() {
    current = (Videos) getItems().getRowData();
  ...
  public String create() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("VideosCreated"));
  ...
  public String update() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("VideosUpdated"));
      return "View";
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/AdminPages").getString("PersistenceErrorOccured"));
      return null;
  ...
  private void performDestroy() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/AdminPages").getString("VideosDeleted"));
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/AdminPages").getString("PersistenceErrorOccured"));
    }
  }
  ...
  public static class VideosControllerConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
      ...
      if (object instanceof Videos) {
        ...
        throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Videos.class.getName());
      }
    }
